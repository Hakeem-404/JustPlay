/*
  # Fix Games Completed Calculation

  1. Updates
    - Improve the `update_player_stats` function to correctly count completed games
    - Fix the calculation of completion rate based on actual participation data
    - Update profile stats to reflect accurate game participation

  2. Changes
    - Modify how completed games are counted for participants
    - Ensure games_played and games_organized are properly updated in profiles
    - Fix completion rate calculation logic
*/

/*
  # Notification System for JustPlay
  ...
  2. Security
    ...
    - Add policies for notification preferences
...
-- Create trigger for new private messages
...
-- Create trigger for new game messages
...
-- Create trigger for new game ratings
